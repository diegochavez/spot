...
//	register_nav_menu('footer-menu','Footer Menu');
    ...
    //add_image_size('magg-home-post',369,220,true);
    add_image_size('pano-archive-image',800,450,true);
    add_image_size('magg-home-post-full',569,338,true);
    add_image_size('blogg-home-image',841,328,true);
    add_image_size('ut-blog-image',830,415,true);
    add_image_size('pano-blog-image',800,450,true);
}
...
if ( function_exists('register_sidebar') ) {
        ...
        register_sidebar(array(
                'name'=>'Header',
        'before_widget' => '<div class="header_ads">',
        'after_widget' => '</div>',
        ...
        'after_title' => '</h3>',
         ...
         register_sidebar(array(
                'name'=>'After Post',
        'before_widget' => '<div class="post_ads">',
        'after_widget' => '</div>',
        'before_title' => '<h3 class="side_title">',
        'after_title' => '</h3>',
    ));

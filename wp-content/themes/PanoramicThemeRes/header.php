...
<!--	<script src="http://cdnjs.cloudflare.com/ajax/libs/modernizr/2.6.2/modernizr.min.js"></script>-->
	...
	<link href="<?php bloginfo('stylesheet_directory'); ?>/js/video-js/video-js.min.css"  type="text/css" rel="stylesheet">
	<script src="<?php bloginfo('stylesheet_directory'); ?>/js/video-js/video.js" type="text/javascript"></script>
	
<?php
/*
	<script src="<?php bloginfo('stylesheet_directory'); ?>/js/fotorama.js" type="text/javascript"></script>
	<link href="<?php bloginfo('stylesheet_directory'); ?>/css/fotorama.css"  type="text/css" rel="stylesheet">
 */ 
?>

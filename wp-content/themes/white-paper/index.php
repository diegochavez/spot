		...
		<div class="content">
			...
			<div class="post-main">
				...
				<div class="post">
					...
					<?php the_content( '' ); ?><div class="more-link"><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php _e( 'Read more...', 'whitepaper' ); ?></a></div>
...
<div class="navigation">
	<div class="alignleft"><?php previous_posts_link(__('&laquo; Newer', 'whitepaper')) ?></div>
	<div class="alignright"><?php next_posts_link(__('Older &raquo;', 'whitepaper')) ?></div>
</div>	
<?php endif; ?>
			<?php endif; ?>
		</div>
